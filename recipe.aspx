...
<body>
    ...
    <p>
        ...
        <p>
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="recipeID" DataSourceID="sqlNewRecipe" DefaultMode="Insert" Height="50px" Width="431px" CssClass="detailview" HorizontalAlign="Center">
                <Fields>
